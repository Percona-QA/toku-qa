...
# hole-punching + aggressive checkpointing + fixed compression (zlib/lzma)
#export TARBALL=blank-hp2acfc.52244-mysql-5.5.28
#export BENCH_ID=hp2acfc.52244.zlib-lzma.64k

# hole-punching + aggressive checkpointing + fixed compression (quicklz/lzma)
#export TARBALL=blank-hp2acfcqlz.52320-mysql-5.5.28
#export BENCH_ID=hp2acfcqlz.52320.qlz-lzma.64k
...
# v6.7.0
export TARBALL=blank-toku670.52126-mysql-5.5.28
export BENCH_ID=670.52126.zlib.64k

# v6.7.2
#export TARBALL=blank-toku672.52815-mysql-5.5.28
#export BENCH_ID=672.52815.zlib.64k
...
if [ ${MYSQL_STORAGE_ENGINE} == "innodb" ]; then
    ...
    if [ -z "$BENCH_ID" ]; then
        export BENCH_ID=hp2ac.52126.${TOKUDB_COMPRESSION}.${TOKUDB_READ_BLOCK_SIZE}
    fi
fi
