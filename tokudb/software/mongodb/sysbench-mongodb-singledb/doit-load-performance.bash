...
#for loaderThreads in 5 ; do
    ...
    export BENCH_ID=${TARBALL}-${WRITE_CONCERN}-${MONGO_REPLICATION}-${loaderThreads}-1db-mmapv1-${mongodbJournalState}
    ...
    export BENCH_ID=${TARBALL}-${MONGO_COMPRESSION}-${WRITE_CONCERN}-${MONGO_REPLICATION}-${loaderThreads}-1db-mxse
    #./doit.bash
    mongo-clean
    unset BENCHMARK_SUFFIX
done
