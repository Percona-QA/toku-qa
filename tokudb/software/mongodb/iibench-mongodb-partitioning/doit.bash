...
if [ -z "$PARTITION_ROWS" ]; then
    export PARTITION_ROWS=-1
fi
if [ -z "$DELETE_AT_ROWS" ]; then
    export DELETE_AT_ROWS=-1
fi
if [ -z "$DELETE_PERCENTAGE" ]; then
    export DELETE_PERCENTAGE=-1
fi
if [ -z "$PERCENTAGE_OVER_ALLOWED" ]; then
    export PERCENTAGE_OVER_ALLOWED=0
fi
